...
async def main() -> None:
    ...
    async with (
        ...
        #         print(f"Found Azure AI Search connection: {ai_search_conn_id}")
        #         break
        ...
        try:
            async with ChatAgent(
                ...
                print("This agent uses raw Azure AI Search tool to search data.\n")
                ...
                print("\n" + "=" * 50 + "\n")
                print("search conversation completed!")
